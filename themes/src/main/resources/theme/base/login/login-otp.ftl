...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('totp'); section>
    <#if section="header">
        ${msg("doLogIn")}
    <#elseif section="loginTotpCodeInputTitle">
        <h1 class="pf-c-title pf-m-3xl pf-u-mb-md">${msg("loginTotpCodeInputTitle")}</h1>
    <#elseif section="form">
        <form id="kc-otp-login-form" class="${properties.kcFormClass!}" action="${url.loginAction}"
            ...
            <div class="${properties.kcFormGroupClass!} ${properties.kcXLgMarginBottom!}">
